...
I travelled with the Interrail Global Pass: 7 travel days to use within one month, in first class. I was not alone, so we had two passes.

Seven days sounds short for two weeks, but it is more than enough if you use them well. I kept the pass days for the long journeys, and on the shorter hops the regional trains did the rest.
