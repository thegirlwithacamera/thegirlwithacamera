...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: lang === "fr" ? "Instagram Ricoh France" : "Instagram Ricoh France",
    description: lang === "fr"
      ? "Contenus Instagram créés pour Ricoh France."
      : "Instagram content created for Ricoh France.",
    alternates: {
      canonical: `/${lang}/seen/instagram-ricoh-france`,
      languages: { fr: "/fr/seen/instagram-ricoh-france", en: "/en/seen/instagram-ricoh-france" }
    },
  };
}
...
const content = {
  fr: {
    pageTitle: "INSTAGRAM RICOH FRANCE",
  ...
  return (
    <main style={{ paddingTop: "60px", paddingBottom: "80px", background: "#ffffff" }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html: JSON.stringify({
        ...
        "@type": "WebPage",
        name: "Instagram Ricoh France",
        url: `https://thegirlwithacamera.com/${lang}/seen/instagram-ricoh-france`,
      })}} />
    </main>
  );
}
