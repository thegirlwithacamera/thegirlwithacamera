...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: lang === "fr" ? "TikTok Ricoh Europe" : "TikTok Ricoh Europe",
    description: lang === "fr"
      ? "Contenus TikTok créés pour Ricoh Europe."
      : "TikTok content created for Ricoh Europe.",
    alternates: {
      canonical: `/${lang}/seen/tiktok-ricoh-europe`,
      languages: { fr: "/fr/seen/tiktok-ricoh-europe", en: "/en/seen/tiktok-ricoh-europe" }
    },
  };
}
  ...
  return (
    <main style={{ paddingTop: "60px", paddingBottom: "80px", background: "#ffffff" }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html: JSON.stringify({
        ...
        "@type": "WebPage",
        name: "TikTok Ricoh Europe",
        url: `https://thegirlwithacamera.com/${lang}/seen/tiktok-ricoh-europe`,
      })}} />
    </main>
  );
}
