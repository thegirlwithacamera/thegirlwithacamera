...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: lang === "fr" ? "Pentax Social Media" : "Pentax Social Media",
    description: lang === "fr"
      ? "Contenus créés pour Pentax sur les réseaux sociaux."
      : "Content created for Pentax on social media.",
    alternates: {
      canonical: `/${lang}/seen/pentax-social-media`,
      languages: { fr: "/fr/seen/pentax-social-media", en: "/en/seen/pentax-social-media" }
    },
  };
}
  ...
  return (
    <main style={{ paddingTop: "60px", paddingBottom: "80px", background: "#ffffff" }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html: JSON.stringify({
        ...
        "@type": "WebPage",
        name: "Pentax Social Media",
        url: `https://thegirlwithacamera.com/${lang}/seen/pentax-social-media`,
      })}} />
    </main>
  );
}
