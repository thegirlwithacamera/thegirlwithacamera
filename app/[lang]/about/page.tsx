...
const RECENT_PROJECTS = {
  fr: [
    ...
    { year: "2026", month: "Janvier", client: "Pentax Europe", desc: "Début de collaboration • Réception Pentax 17 • Développement des concepts" },
    { year: "2025", month: "Novembre", client: "Ricoh Imaging Europe", desc: "Production vidéo UGC • 4 vidéos stop motions" },
    { year: "2025", month: "Octobre - Novembre", client: "Ricoh Imaging Europe", desc: "Production vidéo UGC • 6 micro-content Japon • Tournage sur place" },
    ...
    { year: "2025", month: "Septembre - Octobre", client: "Ricoh Imaging Europe", desc: "Production vidéo UGC • 6 vidéos - lifestyle (1) + micro-content (5)" },
    { year: "2025", month: "Juillet - Août", client: "Ricoh Imaging Europe", desc: "Production vidéo UGC • 3 vidéos - travel (1) + lifestyle (1) + micro-content (1)" },
  ...
  en: [
    ...
    { year: "2026", month: "January", client: "Pentax Europe", desc: "Collaboration start • Pentax 17 reception • Creative concept development" },
    { year: "2025", month: "November", client: "Ricoh Imaging Europe", desc: "UGC video production • 4 stop-motion videos" },
    { year: "2025", month: "October - November", client: "Ricoh Imaging Europe", desc: "UGC video production • 6 Japan micro-content • On-location filming" },
    ...
    { year: "2025", month: "September - October", client: "Ricoh Imaging Europe", desc: "UGC video production • 6 videos - lifestyle (1) + micro-content (5)" },
    { year: "2025", month: "July - August", client: "Ricoh Imaging Europe", desc: "UGC video production • 3 videos - travel (1) + lifestyle (1) + micro-content (1)" },
