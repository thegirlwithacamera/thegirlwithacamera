...
// Formulaire de la page Contact (page Services jusqu'au 16/09). Il poste sur /api/contact, la route qui
...
const t = {
  name: "Name",
  email: "Email",
  company: "Property, brand or organisation",
  type: "You are",
  ...
  types: [
    ...
    ["destination", "Tourism board or destination"],
